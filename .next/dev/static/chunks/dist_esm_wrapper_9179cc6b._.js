...
"[project]/dist/esm/wrapper/convertBase64ToBlob.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/dist/esm/wrapper/convertFrequencyScale.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "convertLinearFrequenciesToBark",
    ()=>convertLinearFrequenciesToBark
]);
...
"[project]/dist/esm/wrapper/generateEmptyFft.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/dist/esm/wrapper/EVIWebAudioPlayer.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$dist$2f$esm$2f$wrapper$2f$convertBase64ToBlob$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/dist/esm/wrapper/convertBase64ToBlob.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$dist$2f$esm$2f$wrapper$2f$convertFrequencyScale$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/dist/esm/wrapper/convertFrequencyScale.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$dist$2f$esm$2f$wrapper$2f$generateEmptyFft$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/dist/esm/wrapper/generateEmptyFft.mjs [app-client] (ecmascript)");
...
class EVIWebAudioPlayer extends EventTarget {
    ...
    constructor(opts = {}){
        ...
        _EVIWebAudioPlayer_fft.set(this, (0, __TURBOPACK__imported__module__$5b$project$5d2f$dist$2f$esm$2f$wrapper$2f$generateEmptyFft$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateEmptyFft"])());
        ...
        if ((_d = opts.fft) === null || _d === void 0 ? void 0 : _d.enabled) {
            ...
            __classPrivateFieldSet(this, _EVIWebAudioPlayer_fftOptions, {
                ...
                transform: transform !== null && transform !== void 0 ? transform : (bins, sampleRate)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$dist$2f$esm$2f$wrapper$2f$convertFrequencyScale$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["convertLinearFrequenciesToBark"])(bins, sampleRate)
            }, "f");
        }
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function*() {
            ...
            if (!__classPrivateFieldGet(this, _EVIWebAudioPlayer_disableAudioWorklet, "f")) {
                try {
                    ...
                    const blob = (0, __TURBOPACK__imported__module__$5b$project$5d2f$dist$2f$esm$2f$wrapper$2f$convertBase64ToBlob$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["convertBase64ToBlob"])(data);
     ...
     */ dispose() {
        ...
        __classPrivateFieldSet(this, _EVIWebAudioPlayer_playing, false, "f");
        __classPrivateFieldSet(this, _EVIWebAudioPlayer_fft, (0, __TURBOPACK__imported__module__$5b$project$5d2f$dist$2f$esm$2f$wrapper$2f$generateEmptyFft$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateEmptyFft"])(), "f");
    }
}
_a = EVIWebAudioPlayer, _EVIWebAudioPlayer_ctx = new WeakMap(), _EVIWebAudioPlayer_workletNode = new WeakMap(), _EVIWebAudioPlayer_analyserNode = new WeakMap(), _EVIWebAudioPlayer_gainNode = new WeakMap(), _EVIWebAudioPlayer_initialized = new WeakMap(), _EVIWebAudioPlayer_playing = new WeakMap(), _EVIWebAudioPlayer_muted = new WeakMap(), _EVIWebAudioPlayer_volume = new WeakMap(), _EVIWebAudioPlayer_disableAudioWorklet = new WeakMap(), _EVIWebAudioPlayer_fft = new WeakMap(), _EVIWebAudioPlayer_fftTimer = new WeakMap(), _EVIWebAudioPlayer_fftOptions = new WeakMap(), _EVIWebAudioPlayer_clipQueue = new WeakMap(), _EVIWebAudioPlayer_currentlyPlayingAudioBuffer = new WeakMap(), _EVIWebAudioPlayer_isProcessing = new WeakMap(), _EVIWebAudioPlayer_lastQueuedChunk = new WeakMap(), _EVIWebAudioPlayer_chunkBufferQueues = new WeakMap(), _EVIWebAudioPlayer_instances = new WeakSet(), _EVIWebAudioPlayer_startAnalyserPollingIfEnabled = function _EVIWebAudioPlayer_startAnalyserPollingIfEnabled() {
    ...
    return __awaiter(this, void 0, void 0, function*() {
        ...
        const blob = (0, __TURBOPACK__imported__module__$5b$project$5d2f$dist$2f$esm$2f$wrapper$2f$convertBase64ToBlob$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["convertBase64ToBlob"])(message.data);
...
//# sourceMappingURL=dist_esm_wrapper_9179cc6b._.js.map