...
export default function TopHeader() {
  ...
  return (
    <TooltipProvider>
      <header className="sticky top-0 z-50 flex h-16 items-center justify-between bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-6">
